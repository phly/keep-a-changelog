...
class BumpBugfixCommand extends Command
{
    private const HELP = <<< 'EOH'
Add a new bugfix entry to the changelog, based on the latest release.

Parses the CHANGELOG.md file to determine the latest release, and creates
a new entry representing the next bugfix release.

EOH;

    protected function configure() : void
    {
        $this->setDescription('Create a new changelog entry for the next bugfix release.');
    ...
    protected function execute(InputInterface $input, OutputInterface $output) : int
    {
        ...
        $version = $bumper->bumpBugfixVersion($latest);
