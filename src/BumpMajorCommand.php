...
class BumpMajorCommand extends Command
{
    private const HELP = <<< 'EOH'
Add a new major release entry to the changelog, based on the latest release.

Parses the CHANGELOG.md file to determine the latest release, and creates
a new entry representing the next major release.

EOH;

    protected function configure() : void
    {
        $this->setDescription('Create a new changelog entry for the next major release.');
    ...
    protected function execute(InputInterface $input, OutputInterface $output) : int
    {
        ...
        $version = $bumper->bumpMajorVersion($latest);
