...
class PrependPatchLinkListenerTest extends AbstractPrependLinkListenerTestCase
{
    ...
    {
        $event->expects($this->any())->method('patchNumber')->willReturn(null);
    }
    ...
    {
        $this->identifier = -1;
        $event->expects($this->any())->method('patchNumber')->willReturn($this->identifier);
    }
